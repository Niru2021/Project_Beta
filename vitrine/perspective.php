<?php include("intro.php");?>
  ...
  <body>
	...
	<div id="boxes"> 
		<div class="box1">
			<img src="img/sud-1-2.jpg" alt="photo de la plage de trinco">
			<div class="para1">
		...
		<div class="box2">
			<img src="img/sud-2-2.jpg" alt="photo d'un temple bouddhiste"
			title="https://upload.wikimedia.org/wikipedia/commons/4/42/Zahntempel_Kandy.jpg">
			<div class="para2">
		...
		<div class="box1">
			<img src="img/sud-3-3.jpg" alt="photo du sigriya"
			title="https://www.serendibleisure.com/hotelsigiriya/wp-content/uploads/sites/3/2019/07/Sigiriya-Rock-Fortress-b3.jpg">
			<div class="para1">
